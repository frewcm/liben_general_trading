      ...
      <div className="w-11/12 mx-auto h-full flex flex-col ">
        <div className="mt-10 flex flex-col items-center justify-center gap-6 font-kanit text-gray-900 text-lg pb-8">
          <p className="text-start leading-9">
            ...
            construction machinery rental, black cumin export, medicine and
            medical device import and wholesale, and BYD electric vehicle
            import. Each of these services reflects our commitment to quality,
          ...
          <p className="text-start leading-9">
            ...
            excavators, loaders, bulldozers, and cranes, all maintained to the
            highest standards. Our flexible rental terms and competitive pricing
            make it easy for construction companies to access the equipment they
            need to complete projects efficiently and effectively. Our dedicated
          ...
          <p className="text-start leading-9">
            ...
            meets international standards for its health benefits and culinary
            uses. We export this premium product to markets worldwide,
            supporting local farmers and contributing to Ethiopia’s economy. Our
          ...
          <p className="text-start leading-9">
            ...
            globe. We ensure that these essential products are available at
            affordable prices, making high-quality healthcare accessible to more
            people. Our efficient and smooth transaction process guarantees
          ...
          <p className="text-start leading-9">
            ...
            represent the future of transportation, offering exceptional
            performance and energy efficiency. By bringing these innovative
            vehicles to Ethiopia, we are contributing to the global shift
          ...
          <p className="text-start leading-9">
            ...
            strong relationships with our clients and partners. Our team is
          ...
          <p className="text-start leading-9">
            ...
            cutting-edge electric vehicles, you can trust us to deliver
            exceptional products and services with integrity and reliability.
          </p>
        </div>
        <div></div>
      </div>
